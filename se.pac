//APAC PAC File
//China - cn.filtering.pac - 2016-11-04
function FindProxyForURL(url, host) {
var resolved_ip = dnsResolve(host);
/*-- Specific OFFICE 365 PROXY settings removed on 2nd June --------------*/
...
/*---SfB WinHTTP Workaround---*/
    if (
        shExpMatch(url, "http*://lyncdiscoverinternal.schneider-electric.com*")
    )
    return "DIRECT";
    if (
        shExpMatch(url, "http*://lyncdiscoverinternal.non.schneider-electric.com*")
    )
    return "DIRECT";
